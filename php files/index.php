...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        <a href="index.php" class="navbar-brand d-flex align-items-center">
            <h2 class="m-0 text-primary">Cyber Solutions</h2>
        </a>
              ...
              <!--  <a href="" class="nav-item nav-link active">Home</a> -->
               ...
               <!-- <div class="nav-item dropdown">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        <a href="target market.html" class="dropdown-item">Target Market </a>
                        <a href="marketing mix.html" class="dropdown-item">Marketing Mix</a>
                        <a href="reflections.html" class="dropdown-item">Reflections</a>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                <h1 class="display-3 text-white animated slideInDown mb-4">Best Cyber Security Solutions For You</h1>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="h-100 bg-dark p-4 p-xl-5">
                        ...
                        <h5 class="text-white">Course Project</h5>
                        <hr class="w-25">
                        <span>Vero elitr justo clita lorem ipsum dolor at sed stet sit diam rebum ipsum et diam justo clita et</span>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="h-100 bg-dark p-4 p-xl-5">
                        ...
                        <h5 class="text-white">Name of Brand Marketing Strategy</h5>
                        <hr class="w-25">
                        <span>Vero elitr justo clita lorem ipsum dolor at sed stet sit diam rebum ipsum et diam justo clita et</span>
                    </div>
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                    <div class="h-100 bg-dark p-4 p-xl-5">
                        ...
                        <h5 class="text-white">Date of Report Submission</h5>
                        <hr class="w-25">
                        <span>Vero elitr justo clita lorem ipsum dolor at sed stet sit diam rebum ipsum et diam justo clita et</span>
                    </div>
                </div>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 ps-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="img/c4.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
        ...
        <div class="container feature px-lg-0">
            <div class="row g-0 mx-lg-0">
                ...
                <div class="col-lg-6 pe-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="img/c5.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0">Mahnoor</h5>
                            <span class="text-primary">Cheif Information Security Officer</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0">Eman</h5>
                            <span class="text-primary">Forensic Expert</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0">Abeera</h5>
                            <span class="text-primary">Cryptographer</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">Cyber Solutions</a>, All Right Reserved.
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    Designed By <a class="border-bottom" href="index.html">Codex Technologies</a><br> <!--Distributed By <a class="border-bottom" href="index.php/" >Themewagon</a> -->
                </div>
            </div>
        </div>
    </div>
