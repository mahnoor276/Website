...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Reflections</h1>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-8 ps-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-500 h-100" src="img/c11.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
                <div class="col-lg-4 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        <div class="bg-primary mb-3" style="width: 60px; height: 2px;"></div>
                        <h1 class="display-5 mb-4">Reflections</h1>
